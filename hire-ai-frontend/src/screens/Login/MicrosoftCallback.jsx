        ...
        {step === "enter_code" && (
          <div className="space-y-5">
            ...
            <input
              ...
              placeholder="000000"
              className="w-full text-center text-2xl font-mono font-bold tracking-widest border-2 border-gray-200 rounded-xl py-4 focus:border-blue-500 focus:ring-4 focus:ring-blue-100 outline-none"
              autoFocus
            />
            ...
            <button
              ...
              className="w-full py-3.5 rounded-xl text-white font-semibold bg-gradient-to-r from-blue-600 to-blue-500 hover:from-blue-700 hover:to-blue-600 disabled:opacity-50 transition-all"
            >
        ...
        {step === "backup" && (
          <div className="space-y-5">
            ...
            <button
              ...
              className="w-full py-3.5 rounded-xl text-white font-semibold bg-gradient-to-r from-blue-600 to-blue-500 hover:from-blue-700 hover:to-blue-600 transition-all"
            >
